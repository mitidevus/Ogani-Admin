...
exports.getApiProducts = async (req, res) => {
    ...
    if (filter === "price-asc") {
        listProducts = await productService.getSortedProductByPrice_ASC(currentPage, cate_id, nameFilter, min, max);
    } else if (filter === "price-desc") {
        listProducts = await productService.getSortedProductByPrice_DESC(currentPage, cate_id, nameFilter, min, max);
